 ...
 * @return the top thin user bar component shared by multiple screens
 */
const UserBar = (props) => {
    console.log(props)
    ...
    const name = props.nom ?
        props.nom : props.user.prenom; //props.user.given_name
    ...
    return (
    <div id="userBar" className="d-flex align-items-center justify-content-start py-1 pl-4">
        {image ?
        <img src={image} alt="portrait" width={"33vw"} height={"33vw"}  style={{ backgroundColor: "white", borderRadius: "50%" }} />
        :
        <span style={{ backgroundColor: "white", borderRadius: "50%", width: "11vw", height: "11vw" }}></span>
        }
